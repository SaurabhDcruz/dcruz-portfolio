...
const MyResume = () => {
    ...
    const steps = [
        { number: '01', title: 'Personal Info', description: 'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.' },
        { number: '02', title: 'Education', description: 'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.' },
        { number: '03', title: 'Work Experience', description: 'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.' },
        { number: '04', title: 'Interview', description: 'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.' },
    ]
    ...
    const educationData = [
        {
            ...
            description: 'This education should be very interactual. Ut tincidunt est ac dolor aliquam sodales. Phasellus sed mauris hendrerit, laoreet sem in, lobortis mauris hendrerit ante.',
            rating: '4.30/5',
            highlight: true,
        },
        {
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="p-4 md:p-8">
                            <div className="max-w-3xl mx-auto">
                                <div className="mb-8">
                                    <span className="text-gray-600">{educationData[0].period}</span>
                                </div>
